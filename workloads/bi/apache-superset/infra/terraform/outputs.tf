output "resource_group_name" {
  description = "Resource group for the Apache Superset blueprint."
  value       = module.aks_platform.resource_group_name
}

output "cluster_name" {
  description = "AKS cluster name for the Apache Superset blueprint."
  value       = module.aks_platform.cluster_name
}

output "superset_node_pool_name" {
  description = "Dedicated AKS node pool used for Apache Superset components."
  value       = var.superset_node_pool_name
}

output "superset_namespace" {
